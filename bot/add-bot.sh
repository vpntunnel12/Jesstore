...
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/Riswan481/Jesstore/main/botol/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/cek-vless "https://raw.githubusercontent.com/Riswan481/Jesstoremain/botol/cek-vless.sh" && chmod +x /usr/bin/cek-vless
