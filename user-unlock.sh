...
RED="\033[0;31m"
BURIQ () {
curl -sS https://raw.githubusercontent.com/scpremium1/jesstunnel/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Riswan481/Jesstore/register | grep $MYIP | awk '{print $2}')
