...
# Develovers » JESTUNNEL
# Email      » Riswanacil00@gmail.com
# telegram   » https://t.me/JesVpnt
...
RED="\033[0;31m"
BURIQ () {
curl -sS https://raw.githubusercontent.com/vpntunnel12/Jesstore/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/vpntunnel12/Jesstore/register | grep $MYIP | awk '{print $2}')
