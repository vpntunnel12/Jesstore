...
function display_menu {
    ...
    echo -e "\033[1;93m──────────────────────────────────────────\033[0m"
    echo -e "  ${ORANGE}[1].${NC}\033[1;97m Install Bot Reseller${NC}"
    echo -e "  ${ORANGE}[2].${NC}\033[1;97m Restart Bot Reseller${NC}"
    echo -e "  ${ORANGE}[3].${NC}\033[1;97m Stop Bot Reseller${NC}"
    echo -e "  ${ORANGE}[4].${NC}\033[1;97m Hapus bot Reseller${NC}"
    echo -e "\033[1;93m──────────────────────────────────────────\033[0m"
    echo -e "  ${ORANGE}[5].${NC}\033[1;97m Install Bot private${NC}"
    echo -e "  ${ORANGE}[6].${NC}\033[1;97m Hapus Bot private${NC}"
    echo -e "  ${ORANGE}[7].${NC}\033[1;97m Stop Bot private${NC}"
    echo -e "  ${ORANGE}[8].${NC}\033[1;97m Restart Bot private${NC}"
    echo -e "  ${ORANGE}[x].${NC}\033[1;97m Exit ${NC}"
    echo -e "\033[1;93m──────────────────────────────────────────\033[0m"
}
