...
function display_menu {
    ...
    echo -e "  ${ORANGE} ${NC}\033[0;36m anda bisa mengunakan bot simpel untuk{NC}"
    echo -e "  ${ORANGE} ${NC}\033[0;36m membuat akun lewat telegram silhakn${NC}"
    echo -e "  ${ORANGE} ${NC}\033[0;36m anda buat bot di telegram cari bot${NC}"
    echo -e "  ${ORANGE} ${NC}\033[0;36m @BotFather silahkan buat bot anda ambik${NC}"
    echo -e "  ${ORANGE} ${NC}\033[0;36m token&id anda untuk cek id ${NC}"
    echo -e "  ${ORANGE} ${NC}\033[0;36m @CekIDTelegram_bot${NC}"
    echo -e "\033[1;93m──────────────────────────────────────────\033[0m"
