...
echo -e "  ${BICyan}[${BIWhite}03${BICyan}] MENU WEBIN"
echo -e "  ${BICyan}[${BIWhite}04${BICyan}] SPEED VPS"
echo -e "  ${BICyan}[${BIWhite}05${BICyan}] ABOT SCRIPT"
echo -e "  ${BICyan}[${BIWhite}06${BICyan}] SET AUTO REBOOT"
echo -e "  ${BICyan}[${BIWhite}07${BICyan}] RESTART ALL SERVICE"
echo -e "  ${BICyan}[${BIWhite}08${BICyan}] GANTI BANNER"
