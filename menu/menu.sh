...
clear
echo -e "${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃                                                    ┃"
echo -e "${BIWhite}┃               ◥꧁Auto Script by Riswan Jabar꧂◤           ${BIWhite}┃"
echo -e "${BIWhite}┃                                                    ┃"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}VERSI OS   ➤ ${BIWhite}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g') ${NC}"
echo -e "${BIWhite}┃ ${NC}UPTIME     ➤ ${BIWhite}$(uptime -p | sed 's/up //') ${NC}"
echo -e "${BIWhite}┃ ${NC}DOMAIN     ➤ ${BIWhite}$(cat /etc/xray/domain) ${NC}"
echo -e "${BIWhite}┃ ${NC}RAM & CPU  ➤ ${BIWhite}$totalram MB / $cpu_usage ${NC}"
echo -e "${BIWhite}┃ ${NC}SWAP RAM   ➤ ${BIWhite}$uram / $tram MB ${NC}"
echo -e "${BIWhite}┃ ${NC}IP VPS     ➤ ${BIWhite}$IPVPS ${NC}"
echo -e "${BIWhite}┃ ${NC}VPS TIME   ➤ ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S") ${NC}"
echo -e "${BIWhite}┃ ${NC}ISP        ➤ ${BIWhite}$ISP ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}SSH      ➤ ${BIWhite}$ssh1  VMESS: $vma  VLESS: $vla  TROJAN: $tra ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}SSH        ➤ ${BIWhite}$ressh      NGINX     ➤ $resngx      XRAY     ➤ $resv2r     ${NC}"
echo -e "${BIWhite}┃ ${NC}STUNNEL    ➤ ${BIWhite}$resst     DROPBEAR  ➤ $resdbr     SSH-WS   ➤ $ressshws    ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}🔹 MENU PILIHAN 🔹 ${NC}"
echo -e "${BIWhite}┃ ${NC}[01] Menu SSH        [08] Tambah Host        [15] Update ${NC}"
echo -e "${BIWhite}┃ ${NC}[02] Menu VMESS      [09] Yang Berjalan       [16] Install UDP ${NC}"
echo -e "${BIWhite}┃ ${NC}[03] Menu VLESS      [10] Install Bot        [17] Backup ${NC}"
echo -e "${BIWhite}┃ ${NC}[04] Menu TROJAN     [11] Bandwidth          [18] Trial ${NC}"
echo -e "${BIWhite}┃ ${NC}[05] Menu Settings   [12] Tema Menu          [19] Keluar ${NC}"
echo -e "${BIWhite}┃ ${NC}[06] Menu Trial      [13] Info Sistem        ${NC}"
echo -e "${BIWhite}┃ ${NC}[07] Menu Backup     [14] Update Sistem      ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}Versi Script ➤ ${BIWhite}$(cat /opt/.ver) ${NC}"
echo -e "${BIWhite}┃ ${NC}Nama Klien   ➤ ${BIWhite}$Name ${NC}"
echo -e "${BIWhite}┃ ${NC}Tanggal Kadaluarsa ➤ ${BIWhite}$exp ➤ ${BIWhite}$exp2 Hari Tersisa ${NC}"
echo -e "${BIWhite}┃ ${NC}WhatsApp Pemilik ➤ 085888801241 ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"

echo -e "\n${BIWhite}╭────────────────────────────────────────────────────╮\033[0m"
echo -e "${BIWhite}┃ ${NC}TERIMAKASIH TELAH MENGGUNAKAN SCRIPT RISWAN JABAR! ${NC}"
echo -e "${BIWhite}╰────────────────────────────────────────────────────╯\033[0m"
echo -e ""
