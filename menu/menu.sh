...
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}VERSI OS  ➤ ${BIYellow}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')     ${NC}"
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}UPTIME    ➤ ${BIYellow}$uptime_info$(uptime -p | sed 's/up //')    ${NC}"  
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}DOMAIN    ➤ ${BIYellow}$(cat /etc/xray/domain)    ${NC}"                              
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}RAM & CPU ➤ ${BIYellow}$totalram MB / $cpu_usage    ${NC}"                           
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}SWAP RAM  ➤ ${BIYellow}$uram / $tram MB    ${NC}"                                      
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}IP VPS    ➤ ${BIYellow}$IPVPS    ${NC}"    
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}VPS TIME  ➤ ${BIYellow}$(date +"%Y-%m-%d %H:%M:%S")    ${NC}"     
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}ISP       ➤ ${BIYellow}$ISP    ${NC}" 
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${CYAN}┃${NC}${BIRed} ${BIYellow}     SSH : $ssh1  VMESS : $vma  VLESS : $vla  TROJAN : $tra $NC"
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
...
echo -e "${CYAN}┃${NC} ${BIRed}  [01] ${BIRed}SSH     ${BIRed}[Menu]      [08] ${BIRed}ADD-HOST    ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [02] ${BIRed}VMESS   ${BIRed}[Menu]      [09] ${BIRed}RUNNING     ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [03] ${BIRed}VLESS   ${BIRed}[Menu]      [10] ${BIRed}INSTALL UDP ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [04] ${BIRed}TROJAN  ${BIRed}[Menu]      [11] ${BIRed}INSTALL BOT ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [05] ${BIRed}SETTINGS${BIRed}[Menu]      [12] ${BIRed}BANDWIDTH   ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [06] ${BIRed}TRIAL   ${BIRed}[Menu]      [13] ${BIRed}MENU THEME  ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}┃${NC} ${BIRed}  [07] ${BIRed}BACKUP  ${BIRed}[Menu]      [14] ${BIRed}UPDATE      ${BIRed}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${CYAN}┃${NC}${BIRed}↪️ Script Versi   ➤ ${BIRed}$(cat /opt/.ver)   ${NC}"
echo -e "${CYAN}┃${NC}${BIRed}🧒 Nama Clinte    ➤ ${BIRed}$Name    ${NC}"
echo -e "${CYAN}┃${NC}${BIRed}🗓️ Expiry Date    ➤ ${BIRed}$exp ${BIRed}➤${BIRed} $exp2${BIRed} Days.   ${NC}"
echo -e "${CYAN}┃${NC}${BIRed}👤 Whastapp Owner ➤ 085888801241     ${NC}"
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
