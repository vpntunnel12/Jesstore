...
echo -e "${CYAN}┃${NC}${BIYellow} \e[41;97;1m        ◥꧁Auto Script by Riswan Jabar꧂◤            \033[0m\e[38;5;196m${NC}"
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}VERSI OS  ➤ ${BIWhite}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')     ${NC}"
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}UPTIME    ➤ ${BIWhite}$uptime_info$(uptime -p | sed 's/up //')    ${NC}"  
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}DOMAIN    ➤ ${BIWhite}$(cat /etc/xray/domain)    ${NC}"                              
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}RAM & CPU ➤ ${BIWhite}$totalram MB / $cpu_usage    ${NC}"                           
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}SWAP RAM  ➤ ${BIWhite}$uram / $tram MB    ${NC}"                                      
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}IP VPS    ➤ ${BIWhite}$IPVPS    ${NC}"    
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}VPS TIME  ➤ ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S")    ${NC}"     
echo -e "${BIWhite}┃${BIWhite} ⇲  ${BIWhite}ISP       ➤ ${BIWhite}$ISP    ${NC}" 
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${BIWhite}┃${NC}${BIRed} ${BIWhite}     SSH : $ssh1  VMESS : $vma  VLESS : $vla  TROJAN : $tra $NC"
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${BIWhite}┃${NC}${BIWhite}  ${BIWhite}  SSH ${NC}: $ressh"" ${BIWhite} NGINX ${NC}: $resngx"" ${BIWhite}  XRAY ${NC}: $resv2r"" ${BIWhite} TROJAN ${NC}: $resv2r"
echo -e "${BIWhite}┃${NC}${BIWhite}   ${BIWhite}   STUNNEL ${NC}: $resst" "${BIWhite} DROPBEAR ${NC}: $resdbr" "${BIWhite} SSH-WS ${NC}: $ressshws" 
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIRed}                 ${BIWhite}🔹 MENU OPTIONS 🔹${NC}                 ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [01] ${BIWhite}SSH     ${BIWhite}[Menu]      [08] ${BIWhite}ADD-HOST    ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [02] ${BIWhite}VMESS   ${BIWhite}[Menu]      [09] ${BIWhite}RUNNING     ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [03] ${BIWhite}VLESS   ${BIWhite}[Menu]      [10] ${BIWhite}INSTALL UDP ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [04] ${BIWhite}TROJAN  ${BIWhite}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [05] ${BIWhite}SETTINGS${BIWhite}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [06] ${BIWhite}TRIAL   ${BIWhite}[Menu]      [13] ${BIWhite}MENU THEME  ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIWhite}  [07] ${BIWhite}BACKUP  ${BIWhite}[Menu]      [14] ${BIWhite}UPDATE      ${BIWhite}[Menu]${NC}  ${CYAN}┃\033[0m${NC}"
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
...
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${BIWhite}┃${NC} ${BIRed} ${BIWhite}TERIMAKASIH SUDAH MENGGUNAKAN SCRIPT RISWAN JABAR${NC}  ${CYAN}┃\033[0m${NC}"          
echo -e "${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e ""
