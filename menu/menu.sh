...
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│OS        : ${PURPLE}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/\"//g')${NC}"
...
echo -e "${PURPLE}│SWAP RAM  : ${PURPLE}$uram / $tram MB${NC}"                                      
echo -e "${PURPLE}│IP VPS    : ${PURPLE}$IPVPS${NC}"    
echo -e "${PURPLE}│VPS TIME  : ${PURPLE}$(date +"%Y-%m-%d %H:%M:%S")${NC}"     
echo -e "${PURPLE}│WA OWNER  : ${PURPLE}wa.me/6285888801241${NC}"
echo -e "${PURPLE}│ISP       : ${PURPLE}$ISP${NC}" 
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│SSH-WS    : ${PURPLE}$ressshws""${NC}"     "${PURPLE}     ➤ ${BOLD_PURPLE}SSH ACCOUNTS    ${NC}: ${PURPLE}$ssh1${NC}"
echo -e "${PURPLE}│NGINX     : ${PURPLE}$resngx""${NC}"    "${PURPLE}     ➤ ${BOLD_PURPLE}VLESS ACCOUNTS  ${NC}: ${PURPLE}$vla${NC}"
echo -e "${PURPLE}│XRAY      : ${PURPLE}$resv2r"" ${NC}"     "${PURPLE}    ➤ ${BOLD_PURPLE}VMESS ACCOUNTS  ${NC}: ${PURPLE}$vma${NC}"
echo -e "${PURPLE}│TROJAN    : ${PURPLE}$resv2r""${NC}"    "${PURPLE}     ➤ ${BOLD_PURPLE}TROJAN ACCOUNTS ${NC}: ${PURPLE}$tra${NC}"
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│                   ${PURPLE}🔹 MENU OPTIONS 🔹${NC}                ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [01] ${PURPLE}SSH     ${BOLD_PURPLE}[Menu]      [08] ${PURPLE}ADD-HOST    ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [02] ${PURPLE}VMESS   ${BOLD_PURPLE}[Menu]      [09] ${PURPLE}RUNNING     ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [03] ${PURPLE}VLESS   ${BOLD_PURPLE}[Menu]      [10] ${PURPLE}INSTALL UDP ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [04] ${PURPLE}TROJAN  ${BOLD_PURPLE}[Menu]      [11] ${PURPLE}INSTALL BOT ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [05] ${PURPLE}SETTINGS${BOLD_PURPLE}[Menu]      [12] ${PURPLE}BANDWIDTH   ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [06] ${PURPLE}TRIAL   ${BOLD_PURPLE}[Menu]      [13] ${PURPLE}MENU THEME  ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}│  [07] ${PURPLE}BACKUP  ${BOLD_PURPLE}[Menu]      [14] ${PURPLE}UPDATE      ${BOLD_PURPLE}[Menu]${NC}   ${BOLD_PURPLE}┃${NC}"
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│ Script Version : ${BOLD_PURPLE}$(cat /opt/.ver)${NC}"
echo -e "${PURPLE}│ Username       : ${BOLD_PURPLE}$Name${NC}"
echo -e "${PURPLE}│ Expiry Date    : ${BOLD_PURPLE}$exp ${BOLD_PURPLE}:${BOLD_PURPLE} $exp2${BOLD_PURPLE} hari lagi${NC}"
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│         ${PURPLE}  THANK YOU FOR USING RZ VPN STORE        │${NC}"          
echo -e "${PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e ""
