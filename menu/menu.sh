...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "${BIYellow}|OS        : $(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/\"//g')${NC}"
echo -e "${BIYellow}|UPTIME    : $uptime_info$(uptime -p | sed 's/up //')${NC}"  
echo -e "${BIYellow}|DOMAIN    : $(cat /etc/xray/domain)${NC}"                              
echo -e "${BIYellow}|RAM & CPU : $totalram MB / $cpu_usage${NC}"                           
echo -e "${BIYellow}|SWAP RAM  : $uram / $tram MB${NC}"                                      
echo -e "${BIYellow}|IP VPS    : $IPVPS${NC}"    
echo -e "${BIYellow}|VPS TIME  : $(date +"%Y-%m-%d %H:%M:%S")${NC}"     
echo -e "${BIYellow}|WA OWNER  : wa.me/6285888801241${NC}"
echo -e "${BIYellow}|ISP       : $ISP${NC}" 
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "${BIYellow}|SSH-WS : $ressshws""${NC}"          "${BOLD_PURPLE}  ➤ ${BIYellow}SSH ACCOUNTS    ${BIYellow}: ${BIYellow}$ssh1${NC}"
echo -e "${BIYellow}|NGINX  : $resngx""${NC}"    "${BOLD_PURPLE}  ➤ ${BIYellow}VLESS ACCOUNTS  ${BIYellow}: ${BIYellow}$vla${NC}"
echo -e "${BIYellow}|XRAY   : $resv2r"" ${NC}"     "${BOLD_PURPLE} ➤ ${BIYellow}VMESS ACCOUNTS  ${BIYellow}: ${BIYellow}$vma${NC}"
echo -e "${BIYellow}|TROJAN : $resv2r""${NC}"    "${BOLD_PURPLE}  ➤ ${BIYellow}TROJAN ACCOUNTS ${BIYellow}: ${BIYellow}$tra${NC}"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "${BIYellow}[01] ${BIYellow}SSH     ${BIYellow}[Menu] [08] ${BIYellow}ADD-HOST    ${BIYellow}[Menu]${NC}"  
echo -e "${BIYellow}[02] ${BIYellow}VMESS   ${BIYellow}[Menu] [09] ${BIYellow}RUNNING     ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "${BIYellow}[03] ${BIYellow}VLESS   ${BIYellow}[Menu] [10] ${BIYellow}INSTALL UDP ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "${BIYellow}[04] ${BIYellow}TROJAN  ${BIYellow}[Menu] [11] ${BIYellow}INSTALL BOT ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "${BIYellow}[05] ${BIYellow}SETTINGS${BIYellow}[Menu] [12] ${BIYellow}BANDWIDTH   ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "${BIYellow}[06] ${BIYellow}TRIAL   ${BIYellow}[Menu] [13] ${BIYellow}MENU THEME  ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "${BIYellow}[07] ${BIYellow}BACKUP  ${BIYellow}[Menu] [14] ${BIYellow}UPDATE      ${BOLD_PURPLE}[Menu]${NC}"  
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "${LightGray}|↪️Script Version : ${LightGray}$(cat /opt/.ver)${NC}"
echo -e "${LightGray}|👤nama Pengguna  : ${LightGray}$Name${NC}"
echo -e "${LightGray}|📆Expiry Date    : ${LightGray}$exp ${LightGray}:${LightGray} $exp2${LightGray} hari${NC}"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
