...
echo -e "\e[33m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m"
echo -e "\e[33m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[0m"
echo -e "\e[33m│  ${BIYellow}OS        :  ${BIYellow}$( cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME//g' | sed 's/=//g' | sed 's/"//g' )${NC}"
echo -e "\e[33m│  ${BIYellow}NS        :  ${BIYellow}$(cat /root/nsdomain)${NC}"
echo -e "\e[33m│  ${BIYellow}DOMAIN    :  ${BIYellow}$(cat /etc/xray/domain)${NC}"
echo -e "\e[33m│  ${BIYellow}RAM & CPU :  ${BIYellow}$totalram MB / $cpu_usage${NC}"
echo -e "\e[33m│  ${BIYellow}SWAP RAM  :  ${BIYellow}$uram / $tram MB${NC}"
echo -e "\e[33m│  ${BIYellow}IP VPS    :  ${BIYellow}$IPVPS${NC}"
echo -e "\e[33m│  ${BIYellow}REBOOT    :  ${BIYellow}jam 02:00 malam${NC}"
echo -e "\e[33m│  ${BIYellow}TELEGRAM  :  ${BIYellow}@Riswanvpnstore${NC}"
echo -e "\e[33m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m"
echo -e "\e[33m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[0m"
echo -e "\e[33m│   ${BIYellow}SSH${NC}    :$ressh"" ${BIYellow}NGINX${NC}    :$resngx"" ${BIYellow}XRAY${NC}   :$resv2r"" ${BIYellow}TROJAN${NC}: $resv2r"
echo -e "\e[33m│   ${BIYellow}STUNNEL${NC}:$resst" "${BIYellow}DROPBEAR${NC} :$resdbr" "${BIYellow}SSH-WS${NC} :$ressshws"
echo -e "\e[33m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m"
echo -e "${BIYellow}             ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
echo -e "\e[33m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m"
echo -e "\e[33m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[0m"
echo -e "\e[33m│${BIYellow} Version Script : $(cat /opt/.ver) Last Update ${BIYellow}"
echo -e "\e[33m│${BIYellow} Username       :\033[1;36m $Name \e[0m"
echo -e "\e[33m│${BIYellow} Expired script :${BIYellow} $exp ${BIYellow}:${BIYellow} $exp2${BIYellow} Days${NC}"
echo -e "\e[33m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m"
echo -e ""
