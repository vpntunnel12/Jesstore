...
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}OS        ➤ ${BIRed}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')${NC}"
echo -e "\e[33m┃${NC} ${BIRed}UPTIME    ➤ ${BIRed}$uptime_info$(uptime -p | sed 's/up //')${NC}"  
echo -e "\e[33m┃${NC} ${BIRed}DOMAIN    ➤ ${BIRed}$(cat /etc/xray/domain)${NC}"                              
echo -e "\e[33m┃${NC} ${BIRed}RAM & CPU ➤ ${BIRed}$totalram MB / $cpu_usage${NC}"                           
echo -e "\e[33m┃${NC} ${BIRed}SWAP RAM  ➤ ${BIRed}$uram / $tram MB${NC}"                                      
echo -e "\e[33m┃${NC} ${BIRed}IP VPS    ➤ ${BIRed}$IPVPS${NC}"    
echo -e "\e[33m┃${NC} ${BIRed}VPS TIME  ➤ ${BIRed}$(date +"%Y-%m-%d %H:%M:%S")${NC}"     
echo -e "\e[33m┃${NC} ${BIRed}ISP       ➤ ${BIRed}$ISP${NC}" 
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC}${BIRed}  ${BIYellow}SSH         VMESS           VLESS          TROJAN $NC"
echo -e "\e[33m┃${NC}${BIRed}  ${Blue} $ssh1            $vma               $vla               $tra $NC"
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
...
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC}${BIRed} SSH-WS    ➤ ${BIRed}$ressshws""            ${BIRed}SSH ACCOUNTS    ➤ ${BIRed}$ssh1  ${NC}"
echo -e "\e[33m┃${NC}${BIRed} NGINX     ➤ ${BIRed}$resngx""  ${NC}""            ${BIRed}VLESS ACCOUNTS  ➤ ${BIRed}$vla  ${NC}"
echo -e "\e[33m┃${NC}${BIRed} XRAY      ➤ ${BIRed}$resv2r""  ${NC}""           ${BIRed}VMESS ACCOUNTS  ➤ ${BIRed}$vma  ${NC}"
echo -e "\e[33m┃${NC}${BIRed} TROJAN    ➤ ${BIRed}$resv2r""  ${NC}""            ${BIRed}TROJAN ACCOUNTS ➤ ${BIRed}$tra  ${NC}"
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}                 ${BIWhite}🔹 MENU OPTIONS 🔹${NC}                 \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [01] ${BIRed}SSH     ${BIRed}[Menu]      [08] ${BIRed}ADD-HOST    ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [02] ${BIRed}VMESS   ${BIRed}[Menu]      [09] ${BIRed}RUNNING     ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [03] ${BIRed}VLESS   ${BIRed}[Menu]      [10] ${BIRed}INSTALL UDP ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [04] ${BIRed}TROJAN  ${BIRed}[Menu]      [11] ${BIRed}INSTALL BOT ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [05] ${BIRed}SETTINGS${BIRed}[Menu]      [12] ${BIRed}BANDWIDTH   ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [06] ${BIRed}TRIAL   ${BIRed}[Menu]      [13] ${BIRed}MENU THEME  ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [07] ${BIRed}BACKUP  ${BIRed}[Menu]      [14] ${BIRed}UPDATE      ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
...
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}      ${BIYellow}   THANK YOU FOR USING RZ VPN STORE${NC}           \e[33m┃\033[0m${NC}"          
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e ""
