...
echo -e "${BOLD_PURPLE}┃  [05] ${PURPLE}SETTINGS${BOLD_PURPLE}[Menu]      [12] ${PURPLE}BANDWIDTH   ${BOLD_PURPLE}[Menu]   ${BOLD_PURPLE}┃${NC}"
echo -e "${BOLD_PURPLE}┃  [06] ${PURPLE}TRIAL   ${BOLD_PURPLE}[Menu]      [13] ${PURPLE}MENU THEME  ${BOLD_PURPLE}[Menu]   ${BOLD_PURPLE}┃${NC}"
echo -e "${BOLD_PURPLE}┃  [07] ${PURPLE}BACKUP  ${BOLD_PURPLE}[Menu]      [14] ${PURPLE}UPDATE      ${BOLD_PURPLE}[Menu]   ${BOLD_PURPLE}┃${NC}"
echo -e "${BOLD_PURPLE}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
