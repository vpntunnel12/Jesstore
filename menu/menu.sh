...
echo -e "${BIRed}┃  [04] ${BIWhite}TROJAN  ${BIRed}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "${BIRed}┃  [05] ${BIWhite}SETTINGS${BIRed}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIRed}[Menu]   ${BIRed}┃${NC}"
