...
echo -e "${BICyan}      └───────────────────────────────────────┘${NC}"
echo -e "${BICyan}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│                \e[41;97;1m 🔹 MENU OPTIONS 🔹 \033[0m \e[38;5;196m ${BOLD_PURPLE}${NC}              │${NC}"
...
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} [04] ${BIYellow}TROJAN  ${BIYellow}[Menu]      [11] ${BIYellow}INSTALL BOT ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} [05] ${BIYellow}SETTINGS${BIYellow}[Menu]      [12] ${BIYellow}BANDWIDTH   ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} [06] ${BIYellow}TRIAL   ${BIYellow}[Menu]      [13] ${BIYellow}MENU THEME  ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
...
echo -e "${BICyan}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│ \e[41;97;1m        Thank you for using your script           \033[0m \e[38;5;196m${BOLD_PURPLE}${NC}│${NC}" 
echo -e "${BICyan}└────────────────────────────────────────────────────┘${NC}"
echo -e ""
