...
echo -e "\033[1;36m               𝗥𝗭 𝗩𝗽𝗻 𝗦𝘁𝗼𝗿𝗲 - 𝗠𝗮𝗻𝗮𝗴𝗲𝗺𝗲𝗻𝘁\033[0m"
echo -e "\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e " ╔══════════════════════════════════════════════════════╗"
...
echo -e " ║ ${BIRed}💻 VPS IP     : ${BIWhite}$IPVPS${NC}                                  ║"
echo -e " ║ ${BIRed}📅 DATE       : ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S")${NC}                   ║"
echo -e " ║ ${BIRed}📡 DOMAIN     : ${BIWhite}$(cat /etc/xray/domain)${NC}                    ║"
echo -e " ║ ${BIRed}⚡ RAM        : ${BIWhite}$totalram MB / $cpu_usage${NC}                ║"
echo -e " ║ ${BIRed}💾 SWAP RAM   : ${BIWhite}$uram / $tram MB${NC}                       ║"
echo -e " ║ ${BIRed}🌍 ISP        : ${BIWhite}$ISP${NC}                                    ║"
echo -e " ║ ${BIRed}📞 WA OWNER   : ${BIWhite}wa.me/6285888801241${NC}                      ║"
echo -e " ║ ${BIRed}💻 VPS Time   : ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S")${NC}                   ║"
echo -e " ╚══════════════════════════════════════════════════════╝"
echo -e "\033[1;32m═════════════════════ Service Status ═════════════════════\033[0m"
echo -e " ╔══════════════════════════════════════════════════════╗"
echo -e " ║ ${BIRed}⭐ SSH-WS     : ${BIYellow}$ressshws${NC}           ➤ ${BIRed}SSH Accounts : ${BIYellow}$ssh1${NC}  ║"
echo -e " ║ ${BIRed}⭐ NGINX      : ${BIYellow}$resngx${NC}           ➤ ${BIRed}VLESS Accounts: ${BIYellow}$vla${NC}   ║"
echo -e " ║ ${BIRed}⭐ XRAY       : ${BIYellow}$resv2r${NC}           ➤ ${BIRed}VMESS Accounts: ${BIYellow}$vma${NC}   ║"
echo -e " ║ ${BIRed}⭐ TROJAN     : ${BIYellow}$resv2r${NC}           ➤ ${BIRed}TROJAN Accounts: ${BIYellow}$tra${NC}  ║"
echo -e " ╚══════════════════════════════════════════════════════╝"
echo -e "\033[1;32m══════════════════ Expiry Information ═══════════════════\033[0m"
echo -e " ╔══════════════════════════════════════════════════════╗"
echo -e " ║ ${BIRed}Script Version : ${BIRed}$(cat /opt/.ver)${NC}                  ║"
echo -e " ║ ${BIRed}Username       : ${BIRed}$Name${NC}                        ║"
echo -e " ║ ${BIRed}Expiry Date    : ${BIRed}$exp ${BIRed}:${BIRed} $exp2 Days${NC}      ║"
echo -e " ╚══════════════════════════════════════════════════════╝"
echo -e "\033[1;36m══════════════════ Menu Options ══════════════════════════\033[0m"
echo -e " ╔══════════════════════════════════════════════════════╗"
echo -e " ║ ${BIYellow}[01] ${BIWhite}SSH Menu          [08] ${BIWhite}Add Host        [15] ${BIWhite}Backup   ║"
echo -e " ║ ${BIYellow}[02] ${BIWhite}VMESS Menu        [09] ${BIWhite}Running Services [16] ${BIWhite}Update   ║"
echo -e " ║ ${BIYellow}[03] ${BIWhite}VLESS Menu        [10] ${BIWhite}Install UDP      [17] ${BIWhite}Logs     ║"
echo -e " ║ ${BIYellow}[04] ${BIWhite}TROJAN Menu       [11] ${BIWhite}Install Bot      [18] ${BIWhite}Reboot   ║"
echo -e " ║ ${BIYellow}[05] ${BIWhite}Settings Menu     [12] ${BIWhite}Bandwidth        [19] ${BIWhite}Exit     ║"
echo -e " ║ ${BIYellow}[06] ${BIWhite}Trial Menu        [13] ${BIWhite}Change Theme     ║"
echo -e " ║ ${BIYellow}[07] ${BIWhite}SSH Backup Menu  [14] ${BIWhite}Install Bot      ║"
echo -e " ╚══════════════════════════════════════════════════════╝"
echo ""
