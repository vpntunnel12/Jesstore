...
echo -e "\033[1;32m║\033[0m${BIYellow}                  𝗔𝘂𝘁𝗼 𝗦𝗰𝗿𝗶𝗽𝘁 𝗥𝗶𝘀𝘄𝗮𝗻 𝗦𝘁𝗼𝗿𝗲${NC}\033[0m"
echo -e "\033[1;32m╔══════════════════════════════════════════════════════╗\033[0m"
echo -e "\033[1;32m║🌐 OS        : ${BIWhite}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')\033[0m"
echo -e "\033[1;32m║⏰ UPTIME    : ${BIWhite}$uptime_info$(uptime -p | sed 's/up //')\033[0m"
echo -e "\033[1;32m║📡 DOMAIN    : ${BIWhite}$(cat /etc/xray/domain)\033[0m"                         
echo -e "\033[1;32m║⚡ RAM & CPU : ${BIWhite}$totalram MB / $cpu_usage\033[0m"                         
echo -e "\033[1;32m║💾 SWAP RAM  : ${BIWhite}$uram / $tram MB\033[0m"                                     
echo -e "\033[1;32m║💻 VPS IP    : ${BIWhite}$IPVPS\033[0m"   
echo -e "\033[1;32m║💻 VPS Time  : ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S")\033[0m"    
echo -e "\033[1;32m║📞 WA OWNER  : ${BIWhite}wa.me/6285888801241\033[0m"
echo -e "\033[1;32m║🌍 ISP       : ${BIWhite}$ISP\033[0m"
echo -e "\033[1;32m╚══════════════════════════════════════════════════════╝\033[0m"
echo -e "\033[1;32m╔══════════════════════════════════════════════════════╗\033[0m"
echo -e "\033[1;32m║⭐ SSH-WS    : ${BIYellow}$ressshws""${NC}"     "${BICyan}     ➤ ${BIRed}SSH ACCOUNTS    ${NC}: ${BIYellow}$ssh1${NC}"
echo -e "\033[1;32m║⭐ NGINX     : ${BIYellow}$resngx""${NC}"    "${BICyan}     ➤ ${BIRed}VLESS ACCOUNTS  ${NC}: ${BIYellow}$vla${NC}"
echo -e "\033[1;32m║⭐ XRAY      : ${BIYellow}$resv2r"" ${NC}"     "${BICyan}    ➤ ${BIRed}VMESS ACCOUNTS  ${NC}: ${BIYellow}$vma${NC}"
echo -e "\033[1;32m║⭐ TROJAN    : ${BIYellow}$resv2r""${NC}"    "${BICyan}     ➤ ${BIRed}TROJAN ACCOUNTS ${NC}: ${BIYellow}$tra${NC}"
echo -e "\033[1;32m╚══════════════════════════════════════════════════════╝\033[0m"
echo -e "\033[1;32m╔══════════════════════════════════════════════════════╗\033[0m"
echo -e "\033[1;32m║                 ${BIWhite}🔹 MENU OPTIONS 🔹${NC}                  ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [01] ${BIWhite}SSH     ${BIRed}[Menu]      [08] ${BIWhite}ADD-HOST    ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [02] ${BIWhite}VMESS   ${BIRed}[Menu]      [09] ${BIWhite}RUNNING     ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [03] ${BIWhite}VLESS   ${BIRed}[Menu]      [10] ${BIWhite}INSTALL UDP ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [04] ${BIWhite}TROJAN  ${BIRed}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [05] ${BIWhite}SETTINGS${BIRed}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [06] ${BIWhite}TRIAL   ${BIRed}[Menu]      [13] ${BIWhite}MENU THEME  ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m║  [07] ${BIWhite}BACKUP  ${BIRed}[Menu]      [14] ${BIWhite}UPDATE      ${BIRed}[Menu]   ${BIRed}┃${NC}"
echo -e "\033[1;32m╚══════════════════════════════════════════════════════╝\033[0m"
echo -e "\033[1;32m╔══════════════════════════════════════════════════════╗\033[0m"
...
echo -e "\033[1;32m║         ${BIYellow}  THANK YOU FOR USING RZ VPN STORE\033[0m"          
echo -e "\033[1;32m╚══════════════════════════════════════════════════════╝\033[0m"
echo -e ""
