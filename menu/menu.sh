...
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} DOMAIN    : $(cat /etc/xray/domain)${NC}"                              
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} RAM & CPU : $totalram MB / $cpu_usage${NC}"                           
...
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} SSH-WS    : $ressshws""${NC}"          "${BOLD_PURPLE}     ➤ ${BIYellow}SSH ACCOUNTS    ${BIYellow}{NC}: ${BIYellow}$ssh1${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} NGINX     : $resngx""${NC}"    "${BOLD_PURPLE}     ➤ ${BIYellow}VLESS ACCOUNTS  ${BIYellow}{NC}: ${BIYellow}$vla${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} XRAY      : $resv2r"" ${NC}"     "${BOLD_PURPLE}    ➤ ${BIYellow}VMESS ACCOUNTS  ${BIYellow}{NC}: ${BIYellow}$vma${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} TROJAN    : $resv2r""${NC}"    "${BOLD_PURPLE}     ➤ ${BIYellow}TROJAN ACCOUNTS ${BIYellow}{NC}: ${BIYellow}$tra${NC}"
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}                   ${PURPLE}🔹 MENU OPTIONS 🔹${NC}               ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [01] ${PURPLE}SSH     ${BOLD_PURPLE}[Menu]      [08] ${PURPLE}ADD-HOST    ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [02] ${PURPLE}VMESS   ${BOLD_PURPLE}[Menu]      [09] ${PURPLE}RUNNING     ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [03] ${PURPLE}VLESS   ${BOLD_PURPLE}[Menu]      [10] ${PURPLE}INSTALL UDP ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [04] ${PURPLE}TROJAN  ${BOLD_PURPLE}[Menu]      [11] ${PURPLE}INSTALL BOT ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [05] ${PURPLE}SETTINGS${BOLD_PURPLE}[Menu]      [12] ${PURPLE}BANDWIDTH   ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [06] ${PURPLE}TRIAL   ${BOLD_PURPLE}[Menu]      [13] ${PURPLE}MENU THEME  ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}  [07] ${PURPLE}BACKUP  ${BOLD_PURPLE}[Menu]      [14] ${PURPLE}UPDATE      ${BOLD_PURPLE}[Menu]${NC}  ${BOLD_PURPLE}│${NC}"
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow}         ${PURPLE}  THANK YOU FOR USING RZ VPN STORE        │${NC}"          
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e ""
