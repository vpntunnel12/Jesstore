...
echo -e "${Lime} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${Lime} │     ${BIWhite}${UWhite}🔹TERIMAKASIH SUDAH MENGUNAKAN SC KEYRIS🔹${NC}"
echo -e "${Lime} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${Lime} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${Lime} │  ${BICyan}OS        :  ${BIWhite}$( cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME//g' | sed 's/=//g' | sed 's/"//g' )${NC}"
echo -e "${Lime} │  ${BICyan}NS        :  ${BIWhite}$(cat /root/nsdomain)${NC}"
echo -e "${Lime} │  ${BICyan}DOMAIN    :  ${BIWhite}$(cat /etc/xray/domain)${NC}"
echo -e "${Lime} │  ${BICyan}RAM & CPU :  ${BIWhite}$totalram MB / $cpu_usage${NC}"
echo -e "${Lime} │  ${BICyan}SWAP RAM  :  ${BIWhite}$uram / $tram MB${NC}"
echo -e "${Lime} │  ${BICyan}IP VPS    :  ${BIWhite}$IPVPS${NC}"
echo -e "${Lime} │  ${BICyan}REBOOT    :  ${BIWhite}jam 02:00 malam${NC}"
echo -e "${Lime} │  ${BICyan}TELEGRAM  :  ${BIWhite}@Riswanvpnstore${NC}"
echo -e "${Lime} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${Lime} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${Lime} │   ${BICyan}[SSH]${GreenYellow}[$ssh1]  ${BICyan}[VMESS]${GreenYellow}[$vma]  ${BICyan}[VLESS]${GreenYellow}[$vla]  ${BICyan}[TROJAN]${GreenYellow}[$tra]$NC"
echo -e "${Lime} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${Lime} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${Lime}│ ${BICyan}[SSH]${NC} [$ressh]"" ${BICyan} [NGINX]${NC}[$resngx]"" ${BICyan}  [XRAY]${NC}[$resv2r]"" ${BICyan} [TROJAN]${NC}[$resv2r]"
echo -e " ${Lime}│ ${BICyan}[STUNNEL]${NC}[$resst]" "${BICyan} [DROPBEAR]${NC}[$resdbr]" "${BICyan} [SSH-WS]${NC}[$ressshws]"
echo -e "${Lime} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${Lime} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}01${BICyan}] SSH     ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}08${BICyan}] ADD-HOST        ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}02${BICyan}] VMESS   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}09${BICyan}] RUNNING         ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}03${BICyan}] VLESS   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}10${BICyan}] INSTALL UDP     ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}04${BICyan}] TROJAN  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}11${BICyan}] INSTALL BOT     ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}05${BICyan}] SETING  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}12${BICyan}] BANDWITH        ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}06${BICyan}] TRIALL  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}13${BICyan}] MENU THEME      ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} │  ${BICyan}[${BIWhite}07${BICyan}] BACKUP  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}14${BICyan}] UPDATE SCRIPT   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${Lime} │${NC}"
echo -e "${Lime} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${Lime}    ┌──────────────────────────────────────────────┐${NC}"
echo -e "${Lime}    │${BIWhite} Version Script : $(cat /opt/.ver) Last Update ${BIWhite}"
echo -e "${Lime}    │${BIWhite} Username       :\033[1;36m $Name \e[0m"
echo -e "${Lime}    │${BIWhite} Expired script :${BIWhite} $exp ${BIWhite}:${BIWhite} $exp2${BIWhite} Days${NC}"
echo -e "${Lime}    └─────────────────────────────────────────────┘${NC}"
echo -e ""
