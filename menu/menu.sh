...
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} SSH-WS    : $ressshws""${NC}"          "${BOLD_PURPLE} ➤ ${BOLD_PURPLE}SSH ACCOUNTS    ${NC}: ${BOLD_PURPLE}$ssh1${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} NGINX     : $resngx""${NC}"    "${BOLD_PURPLE}     ➤ ${BOLD_PURPLE}VLESS ACCOUNTS  ${NC}: ${BOLD_PURPLE}$vla${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} XRAY      : $resv2r"" ${NC}"     "${BOLD_PURPLE}    ➤ ${BOLD_PURPLE}VMESS ACCOUNTS  ${NC}: ${BOLD_PURPLE}$vma${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} TROJAN    : $resv2r""${NC}"    "${BOLD_PURPLE}     ➤ ${BOLD_PURPLE}TROJAN ACCOUNTS ${NC}: ${BOLD_PURPLE}$tra${NC}"
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
