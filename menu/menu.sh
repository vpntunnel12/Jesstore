...
echo -e "║━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "║ ${BICyan}OS        : ${BIWhite}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')${NC}"
echo -e "║ ${BICyan}DOMAIN    : ${BIWhite}$(cat /etc/xray/domain)${NC}"                              
echo -e "║ ${BICyan}RAM & CPU : ${BIWhite}$totalram MB / $cpu_usage${NC}"                           
echo -e "║ ${BICyan}SWAP RAM  : ${BIWhite}$uram / $tram MB${NC}"                                      
echo -e "║ ${BICyan}IP VPS    : ${BIWhite}$IPVPS${NC}"                                                 
echo -e "║ ${BICyan}REBOOT    : ${BIWhite}jam 02:00 malam${NC}"      
echo -e "║ ${BICyan}Owner Sc  : ${BIWhite}wa.me/6285888801241${NC}"
echo -e "║━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "║${BIYellow}🔧 Service Status    &    Total akun premium ${NC}"
echo -e "║━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "║${BICyan} SSH-WS    : ${BIYellow}$ressshws""${NC}"     "${BICyan}     ➤ ${BIWhite}SSH ACCOUNTS    ${NC}: ${BIYellow}$ssh1${NC}"
echo -e "║${BICyan} NGINX     : ${BIYellow}$resngx""${NC}"    "${BICyan}     ➤ ${BIWhite}VLESS ACCOUNTS  ${NC}: ${BIYellow}$vla${NC}"
echo -e "║${BICyan} XRAY      : ${BIYellow}$resv2r"" ${NC}"     "${BICyan}    ➤ ${BIWhite}VMESS ACCOUNTS  ${NC}: ${BIYellow}$vma${NC}"
echo -e "║${BICyan} TROJAN    : ${BIYellow}$resv2r""${NC}"    "${BICyan}     ➤ ${BIWhite}TROJAN ACCOUNTS ${NC}: ${BIYellow}$tra${NC}"
echo -e "║${BICyan} STUNNEL   : ${BIYellow}$resst""${NC}"  
echo -e "║${BICyan} DROPBEAR  : ${BIYellow}$resdbr""${NC}" 
echo -e "║━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${BIBrightYellow}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮${NC}"
echo -e "${BIBrightYellow}┃                 ${BIWhite}🔹 MENU OPTIONS 🔹${NC}                  ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [01] ${BIWhite}SSH     ${BIBrightYellow}[Menu]      [08] ${BIWhite}ADD-HOST    ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [02] ${BIWhite}VMESS   ${BIBrightYellow}[Menu]      [09] ${BIWhite}RUNNING     ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [03] ${BIWhite}VLESS   ${BIBrightYellow}[Menu]      [10] ${BIWhite}INSTALL UDP ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [04] ${BIWhite}TROJAN  ${BIBrightYellow}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [05] ${BIWhite}SETTINGS${BIBrightYellow}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [06] ${BIWhite}TRIAL   ${BIBrightYellow}[Menu]      [13] ${BIWhite}MENU THEME  ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}┃  [07] ${BIWhite}BACKUP  ${BIBrightYellow}[Menu]      [14] ${BIWhite}UPDATE      ${BIBrightYellow}[Menu]   ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
...
echo -e "║${BICyan} Expiry Date    : ${BIWhite}$exp ${BIWhite}:${BIWhite} $exp2${BIWhite} Days${NC}"
echo -e "║━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${BIBrightYellow}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮${NC}"
echo -e "${BIBrightYellow}┃           ${BIWhite}THANK YOU FOR USING RZ VPN STORE${NC}          ${BIBrightYellow}┃${NC}"
echo -e "${BIBrightYellow}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
echo -e ""
