...
echo -e "\e[33m┃${NC} ${BIRed}DOMAIN    ➤ ${BIWhite}$(cat /etc/xray/domain)${NC}"                              
echo -e "\e[33m┃${NC} ${BIRed}RAM & CPU ➤ ${BIWhite}$totalram MB / $cpu_usage${NC}"                           
echo -e "\e[33m┃${NC} ${BIRed}SWAP RAM  ➤ ${BIWhite}$uram / $tram MB${NC}"                                      
echo -e "\e[33m┃${NC} ${BIRed}IP VPS    ➤ ${BIWhite}$IPVPS${NC}"    
echo -e "\e[33m┃${NC} ${BIRed}VPS TIME  ➤ ${BIWhite}$(date +"%Y-%m-%d %H:%M:%S")${NC}"     
echo -e "\e[33m┃${NC} ${BIRed}ISP       ➤ ${BIWhite}$ISP${NC}" 
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\e[33m┃${NC}${BIRed} SSH-WS     ➤ ${BIYellow}$ressshws""${NC}"     "${BICyan}            ${BIRed}SSH ACCOUNTS    ${NC}➤ ${BIYellow}$ssh1${NC}"
echo -e "\e[33m┃${NC}${BIRed} NGINX      ➤ ${BIYellow}$resngx""${NC}"    "${BICyan}            ${BIRed}VLESS ACCOUNTS  ${NC}➤ ${BIYellow}$vla${NC}"
...
echo -e "\e[33m┃${NC} ${BIRed}  [01] ${BIWhite}SSH     ${BIRed}[Menu]      [08] ${BIWhite}ADD-HOST    ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [02] ${BIWhite}VMESS   ${BIRed}[Menu]      [09] ${BIWhite}RUNNING     ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [03] ${BIWhite}VLESS   ${BIRed}[Menu]      [10] ${BIWhite}INSTALL UDP ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [04] ${BIWhite}TROJAN  ${BIRed}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [05] ${BIWhite}SETTINGS${BIRed}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [06] ${BIWhite}TRIAL   ${BIRed}[Menu]      [13] ${BIWhite}MENU THEME  ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m┃${NC} ${BIRed}  [07] ${BIWhite}BACKUP  ${BIRed}[Menu]      [14] ${BIWhite}UPDATE      ${BIRed}[Menu]${NC}  \e[33m┃\033[0m${NC}"
echo -e "\e[33m╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\e[33m╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
