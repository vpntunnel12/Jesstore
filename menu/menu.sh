...
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} SSH-WS    : $ressshws""${NC}"          "${BOLD_PURPLE}    ➤ ${BIYellow}SSH ACCOUNTS    ${NC}: ${BIYellow}$ssh1${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} NGINX     : $resngx""${NC}"    "${BOLD_PURPLE}     ➤ ${BIYellow}VLESS ACCOUNTS  ${NC}: ${BIYellow}$vla${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} XRAY      : $resv2r"" ${NC}"     "${BOLD_PURPLE}    ➤ ${BIYellow}VMESS ACCOUNTS  ${NC}: ${BIYellow}$vma${NC}"
echo -e "${BOLD_PURPLE}│${NC} ${BIYellow} TROJAN    : $resv2r""${NC}"    "${BOLD_PURPLE}     ➤ ${BIYellow}TROJAN ACCOUNTS ${NC}: ${BIYellow}$tra${NC}"
echo -e "${BOLD_PURPLE}└────────────────────────────────────────────────────┘${NC}"
echo -e "${BOLD_PURPLE}┌────────────────────────────────────────────────────┐${NC}"
