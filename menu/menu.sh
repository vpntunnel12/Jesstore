...
echo -e "${BICyan} ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬${NC}"
echo -e "${BICyan} │  ${BICyan}OS        :  ${BIWhite}$( cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME//g' | sed 's/=//g' | sed 's/"//g' )${NC}"
echo -e "${BICyan} │  ${BICyan}NS        :  ${BIWhite}$(cat /root/nsdomain)${NC}"
echo -e "${BICyan} │  ${BICyan}DOMAIN    :  ${BIWhite}$(cat /etc/xray/domain)${NC}"
echo -e "${BICyan} │  ${BICyan}RAM & CPU :  ${BIWhite}$totalram MB / $cpu_usage${NC}"
echo -e "${BICyan} │  ${BICyan}SWAP RAM  :  ${BIWhite}$uram / $tram MB${NC}"
echo -e "${BICyan} │  ${BICyan}IP VPS    :  ${BIWhite}$IPVPS${NC}"
echo -e "${BICyan} │  ${BICyan}REBOOT    :  ${BIWhite}jam 02:00 malam${NC}"
echo -e "${BICyan} │  ${BICyan}TELEGRAM  :  ${BIWhite}@Riswanvpnstore${NC}"
echo -e "${BICyan} ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬${NC}"
echo -e "${BICyan} │   ${Blue}[SSH]${BIYellow}[$ssh1]  ${BICyan}[VMESS]${BIYellow}[$vma]  ${BICyan}[VLESS]${BIYellow}[$vla]  ${BICyan}[TROJAN]${BIYellow}[$tra]$NC"
echo -e "${BICyan} ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬${NC}"
echo -e " ${BICyan}│  [SSH]${BICyan}[$ressh]"" ${BICyan} [NGINX]${NC}[$resngx]"" ${BICyan}  [XRAY]${NC}[$resv2r]"" ${BICyan} [TROJAN]${NC}[$resv2r]"
