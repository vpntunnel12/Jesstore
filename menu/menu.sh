...
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}VERSI OS  ➤ ${BIRed}$(cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME=//g' | sed 's/"//g')     ${NC}"
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}UPTIME    ➤ ${BIRed}$uptime_info$(uptime -p | sed 's/up //')    ${NC}"  
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}DOMAIN    ➤ ${BIRed}$(cat /etc/xray/domain)    ${NC}"                              
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}RAM & CPU ➤ ${BIRed}$totalram MB / $cpu_usage    ${NC}"                           
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}SWAP RAM  ➤ ${BIRed}$uram / $tram MB    ${NC}"                                      
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}IP VPS    ➤ ${BIRed}$IPVPS    ${NC}"    
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}VPS TIME  ➤ ${BIRed}$(date +"%Y-%m-%d %H:%M:%S")    ${NC}"     
echo -e "${CYAN}┃${BICyan} ⇲  ${BICyan}ISP       ➤ ${BIRed}$ISP    ${NC}" 
echo -e "${CYAN}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "${CYAN}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
