...
echo -e "\033[1;32m║  [04] ${BIWhite}TROJAN  ${BIRed}[Menu]      [11] ${BIWhite}INSTALL BOT ${BIRed}[Menu]    \033[1;32m║\033[0m"
echo -e "\033[1;32m║  [05] ${BIWhite}SETTINGS${BIRed}[Menu]      [12] ${BIWhite}BANDWIDTH   ${BIRed}[Menu]    \033[1;32m║\033[0m"
echo -e "\033[1;32m║  [06] ${BIWhite}TRIAL   ${BIRed}[Menu]      [13] ${BIWhite}MENU THEME  ${BIRed}[Menu]    \033[1;32m║\033[0m"
...
echo -e "\033[1;32m║ Expiry Date    : ${BIRed}$exp ${BIRed}:Sisa ${BIRed} $exp2${BIRed} hari lagi${NC}"          
echo -e "\033[1;32m╚══════════════════════════════════════════════════════╝\033[0m"
echo -e ""
